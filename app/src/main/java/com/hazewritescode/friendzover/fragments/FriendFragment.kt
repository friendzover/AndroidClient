...
class FriendFragment : Fragment() {
    ...
    fun onButtonPressed(uri: Uri) {
        listener?.onFriendFragmentInteraction(uri)
    }

    override fun onAttach(context: Context) {
        super.onAttach(context)
        if (context is OnFriendFragmentInteractionListener) {
            listener = context
        } else {
     ...
     */
    interface OnFriendFragmentInteractionListener {
        // TODO: Update argument type and name
        fun onFriendFragmentInteraction(uri: Uri)
    }
